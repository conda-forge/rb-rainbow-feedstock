...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-rainbow-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7693&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-rainbow-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-rainbow` can be installed with:

```
conda install rb-rainbow
```

It is possible to list all of the versions of `rb-rainbow` available on your platform with:
